...
def load_tab1(self):
    ...
    try:
        ...
        if opsystem == 'Windows':
            self.sampleRDriveLineEdit.setPlainText('R:\crd_G9000\AVXxx\3610-NUV1022\R&D\Calibration')  ## Windows
        elif opsystem == 'Darwin':
            self.sampleRDriveLineEdit.setPlainText(
                '/Volumes/Data/crd_G9000/AVXxx/3610-NUV1022/R&D/Calibration/')  ## Mac
        else:
            self.sampleRDriveLineEdit.setPlainText('/mnt/r/crd_G9000/AVXxx/3610-NUV1022/R&D/Calibration/')  ## Linux
